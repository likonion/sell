            ...
            <ul v-show="food.ratings && food.ratings.length">
              <li v-show="needShow(rating.rateType,rating.text)" v-for="rating in food.ratings"
                ...
                <div class="user">
                  ...
                  <img :src="rating.avatar" class="avatr" width="12" height="12" alt="">
                </div>
...
<script type="text/ecmascript-6">
  ...
  import Vue from 'vue';
  import {fomatDate} from 'common/js/data';
  ...
  export default {
    ...
    methods: {
      ...
      addFirst(event) {
        ...
        let el = event.target.parentNode.querySelector('.cart-add');
        this.$emit('cartAdd', el);
      },
      needShow(type, text) {
        this.$nextTick(() => {
        ...
        if (this.$store.state.selectType === 2) {
          return true;
        } else if (this.$store.state.selectType === 0 && type === 0) {
          return true;
        } else if (this.$store.state.selectType === 1 && type === 1) {
          return true;
        }
      }
    },
    filters: {
      formatDate(time) {
        ...
        return fomatDate(date, 'yyyy-MM-dd hh:ss');
      }
    },
    components: {
